  ...
  return (
    <section id="apply" className="py-8 bg-white">
      <div className="max-w-4xl mx-auto px-6 text-center">
        <div className="bg-slate-50 border border-slate-100 p-8 md:p-10 rounded-sm shadow-sm">
          ...
          <div className="space-y-6">
            ...
            <p className="text-sm text-slate-400">
              Ao clicar, você preencherá um formulário diagnóstico para nossa equipe avaliar seu caso.
            </p>
          </div>
        </div>
      </div>
