        ...
        <div className="flex flex-col lg:flex-row items-center gap-16 lg:gap-24">
          <div className="w-full lg:w-3/5 text-center lg:text-left">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-6">
              ...
              >
                <span className="relative z-10 uppercase tracking-widest text-sm">Aplicar para Sessão Diagnóstica</span>
          ...
          <div className="w-full lg:w-2/5 max-w-md mx-auto">
            <div className="relative group">
              ...
              <div className="absolute -bottom-4 -left-4 bg-white p-6 shadow-2xl z-20 hidden md:block border-t-4 border-[#C5A059]">
                 <p className="text-[#0A192F] font-bold text-sm uppercase tracking-tighter">Foco em Estrutura</p>
                 <p className="text-slate-500 text-[10px] uppercase tracking-widest mt-1">E Harmonia Familiar</p>
              </div>
            </div>
          </div>
        </div>
