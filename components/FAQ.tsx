...
const FAQ: React.FC<FAQProps> = ({ onApplyClick }) => {
  return (
    <section id="faq" className="py-8 bg-slate-50 scroll-mt-20 overflow-hidden">
      <div className="max-w-3xl mx-auto px-6 text-center">
        <h2 className="text-3xl font-bold text-slate-900 mb-6 reveal">Dúvidas Frequentes</h2>
        ...
        <div className="bg-white p-6 rounded-sm border border-slate-200 shadow-sm reveal" style={{ transitionDelay: '400ms' }}>
          <p className="text-slate-600 mb-4 text-sm font-light italic">Sua dúvida é muito específica para o seu negócio familiar?</p>
          <button 
